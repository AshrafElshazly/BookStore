...
<section class="hero-wrap" style="background-image: url(<?php w_assets('images/bg_1.jpg') ?>);" data-stellar-background-ratio="0.5">
...
<section class="ftco-section">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6 img img-3 d-flex justify-content-center align-items-center" style="background-image: url(<?php w_assets('images/about-1.jpg'); ?>);">
            </div>
            ...
            <div class="col-md-6 col-lg-4 d-flex">
                <div class="book-wrap d-lg-flex">
                    ...
                    <div class="text p-4">
                        ...
                        <h2><a href="#"></a><?php echo $book['name']; ?></h2>
                        <span class="position">By Ashraf Elshazly</span>
                    </div>
                </div>
            </div>
            <?php endforeach; ?>
