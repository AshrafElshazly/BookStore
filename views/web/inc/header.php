...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="<?php w_assets('css/animate.css');?>">
    <link rel="stylesheet" href="<?php w_assets('css/owl.carousel.min.css');?>">
    <link rel="stylesheet" href="<?php w_assets('css/owl.theme.default.min.css');?>">
    <link rel="stylesheet" href="<?php w_assets('css/magnific-popup.css');?>">
    <link rel="stylesheet" href="<?php w_assets('css/flaticon.css');?>">
    <link rel="stylesheet" href="<?php w_assets('css/style.css');?>">
